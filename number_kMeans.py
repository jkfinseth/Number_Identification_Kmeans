...
# Properly scale data to be within [-1,1]
...
#Seperate data into samples and features
...
# Define a way to test our accuracy (taken from SK learn)
...
# n_c = number of clustsers
# init = method of guessing (Can preset to cut off some training time)
# n_init = number of generations
